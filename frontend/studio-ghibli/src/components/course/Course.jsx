    ...
    <Container>
      ...
      <CourseTextWrapper>
        ...
        <CourseRateWrapper>
          ...
          <CourseRateReviewerNum>({item.rating})</CourseRateReviewerNum>
        </CourseRateWrapper>
      ...
      >
        ...
        >
          <p>
            Are you sure you want to enroll in this course for{" "}
          ...
          >
            ...
            <div>
              <p>
                ...
                <strong>€{item.onSale ? item.onSalePrice : item.price}</strong>
              </p>
            </div>
          </form>
        </DialogContent>
