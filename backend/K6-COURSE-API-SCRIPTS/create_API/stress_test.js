...
export default function (data) {
    const payload = {
        title: generateRandomData(10),
        description: generateRandomData(50),
        course_content: generateRandomData(100),
        learning_outcomes: generateRandomData(10),
        course_inclusions: generateRandomData(10),
        is_certified: Math.round(Math.random()),
        price: "199.00",
        status: 1,
        rating: (Math.floor(Math.random() * 5) + 1),
        total_enrollments: (Math.floor(Math.random() * 100) + 1),
        author: generateRandomData(15)
    };
